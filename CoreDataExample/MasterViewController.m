...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    NSFetchedResultsController *results = [[NSFetchedResultsController alloc] initWithFetchRequest:fetch managedObjectContext:self.managedObjectContext sectionNameKeyPath:nil cacheName:nil];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([[segue identifier] isEqualToString:@"showDetail"]) {
        ...
        [[segue destinationViewController] setDetailItemEdition:YES];
    }
    if ([[segue identifier] isEqualToString:@"newDetail"]) {
        [[segue destinationViewController] setDetailItemEdition:NO];
    }
}
